...
{
	//queue_delayed_work(px3003b_struct_wq, &px3003b_workq,0);
//	printk( "alp.D : px3003b_workqueue_function wake_lock_timeout+");
	wake_lock_timeout(&ps_sensor_data->wake_lock,1*HZ);
//	printk( "alp.D : px3003b_workqueue_function wake_lock_timeout-");
	queue_work(px3003b_struct_wq, &px3003b_workq);
