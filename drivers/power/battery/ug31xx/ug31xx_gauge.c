...
#include "ug31xx_ggb_data_PF400CG_PR2_20140306_131224.h"
#include "ug31xx_ggb_data_PF400CG_2ND_20140306_131721.h"
#include "ug31xx_ggb_data_A400CG_DEF_20140306_132212.h"
#include "ug31xx_ggb_data_A400CG_3RD_20140314_140424.h"
#else // ME175CG && A450CG
#if defined(CONFIG_A450CG)
#include "ug31xx_ggb_data_A450CG_DEF_20140312_195852.h"
#else // ME175CG
...
#define	BUSY_BATTERY_UPDATE_RSOC	(5)
...
static int ug31xx_i2c_resume(struct i2c_client *client)
{
	...
	else
	{
		...
		else if((predict_rsoc < BUSY_BATTERY_UPDATE_RSOC) &&
