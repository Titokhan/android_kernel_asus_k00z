...
//	{RT5640_I2S1_SDP	, 0xD000},//change IIS1 and IIS2
	/*record*/
	{RT5640_IN1_IN2		, 0x1100},//IN1 boost 0db and signal ended mode
...
int rt5640_headset_detect(struct snd_soc_codec *codec, int jack_insert)
{
	...
	if(jack_insert) {
		...
		printk("headphone retry time %d, %x, %d\n", headphone_retry_time, snd_soc_read(codec, RT5640_PWR_DIG1) & 0x1800, dac_is_unmute);
/*		if (headphone_retry_time == 3 && (snd_soc_read(codec, RT5640_PWR_DIG1) & 0x1800) == 0 && dac_is_unmute == 1) {
...
*/	} else {
		snd_soc_update_bits(codec, RT5640_MICBIAS,
			...
			RT5640_MIC1_OVCD_DIS);
                // Don't close the LDO2 when removing headset for ME175CG
		//snd_soc_update_bits(codec, RT5640_PWR_ANLG1,
		//	RT5640_PWR_LDO2, 0);
